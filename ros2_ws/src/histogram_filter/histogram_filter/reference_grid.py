...
GRID = [
    ...
    [0.0, 0.0, 0.0],
    [0.10, 0.0, 0.0],
    [0.10, 0.0, 90.0],  # scan 2
    [0.10, 0.10, 90.0],  # scan 3
    [0.10, 0.10, -180.0],
    [0.0, 0.10, -180.0],
    [0.0, 0.10, 90.0],  # scan 4
    [0.0, 0.10, -180.0],
    [-0.10, 0.10, -180.0],
    [-0.10, 0.10, 90.0],  # scan 5
    [-0.10, 0.10, -90.0],
    [-0.10, 0.0, -90.0],
    [-0.10, 0.0, 90.0],  # scan 6
    [-0.10, 0.0, -90.0],
    [-0.10, -0.10, -90.0],
    [-0.10, -0.10, 90.0],  # scan 7
    [-0.10, -0.10, 0.0],
    [0.0, -0.10, 0.0],
    [0.0, -0.10, 90.0],  # scan 8
    [0.0, -0.10, 0.0],
    [0.10, -0.10, 0.0],
    [0.10, -0.10, 90.0],  # scan 9
]
...
GRID2 = [
    [0.0, 0.0, 0.0],
    [0.25, 0.0, 0.0],
    [0.25, 0.0, 90.0],  # scan 2
    [0.25, 0.25, 90.0],  # scan 3
    [0.25, 0.25, -180.0],
    [0.0, 0.25, -180.0],
    [-0.25, 0.25, -180.0],
    [-0.25, 0.25, -90.0],
