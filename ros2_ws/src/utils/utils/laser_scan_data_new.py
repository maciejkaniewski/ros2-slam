...
class LaserScanDataNew:
    ...
    def __init__(self, coords: Tuple[float, float, float], measurements: array.array):
        """
        Initializes a LaserScanData object.

        Args:
            coords (Tuple[float, float, float]): The coordinates and the angle of the laser scan data.
